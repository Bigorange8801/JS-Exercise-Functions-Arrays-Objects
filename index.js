...
function getCarInfoByIndex(inventory, index) {
  ...
  /* code here */ return `This is a ${car.car_make} ${car.car_model}`;
}
 ...
 * it will return `This is a Lincoln Navigator`.
 */
/* pseudo code = comments of what you are about to code
I want to return a car by the given id*/

function getCarInfoById(/* code here */inventory, num) {
  /* code here */
